...
public class Departamento {
	 ...
	 * @param tipoDir String con los valores 'P' o 'F'. Deben de indicarse exclusivamente uno de esos dos caracteres porque sino no podrá hacerse el cambio en la base de datos.
	 */
	...
	/**
	 * Método que indica si dos objetos de la clase {@link Departamento} son iguales. Dos departamentos solo serán iguales si tienen la misma clave primaria (codDepartamento).
	 */
	@Override
