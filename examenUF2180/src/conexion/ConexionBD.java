...
/**
 * Clase necesaria para establecer la conexión con la base de datos.
 * El administrador de la base de datos deberá de ser el único capaz de manejar esta información para salvaguardar la integridad y seguridad de la BBDD.
 * 
 * @param database String Indicar el nombre de la base de datos.
 * @param usuario String Insertar el usuario para el manejo de la base de datos.
 * @param contrasena String Insertar la contraseña para el acceso autentificado a la base de datos.
...
/**
 * Getter del objeto Connection. 
 * En caso de que no haya una conexión previa activa: 
 * -Registra el driver de MySQL.
 * -Conecta a la base de datos.
 * 
 * En caso de que haya una conexión previa anterior:
 * -Se mantiene conectado en dicha conexión.
 * 
